...
export default function AdminOrdersPage() {
    ...
    const [paymentStatusFilter, setPaymentStatusFilter] = useState<string | 'all'>('all'); // Thêm state filter
    ...
    // --- Logic fetch danh sách đơn hàng ---
    const {
        data: orders,
        isLoading: isLoadingOrders,
        error: ordersQueryError,
    } = useQuery<Order[], Error>({
        queryKey: ['adminOrders', paymentStatusFilter], // Thêm paymentStatusFilter vào queryKey
        queryFn: async () => {
            if (userRole !== 'admin') {
    ...
    }, [userRole, isLoadingOrders, ordersQueryError, queryClient, supabaseClient]);
    ...
    return (
        <div className="container mx-auto p-4">
            ...
            {/* Dropdown lọc theo trạng thái thanh toán */}
            <div className="mb-4 flex justify-end">
                <div className="flex items-center">
                    <label htmlFor="paymentStatusFilter" className="mr-2 text-sm font-medium text-gray-700">
                        Lọc theo trạng thái:
                    </label>
                    <select
                        ...
                        className="mt-1 block w-full sm:text-sm border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 max-w-xs"
                    >
